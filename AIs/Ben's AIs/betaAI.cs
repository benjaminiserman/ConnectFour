...
public class BetaAI : AI
{
	public override string Name => "BetaAI";

	public BetaAI()
	{
		if (!(this is PsychAI || this is AssistAI)) Say("Good luck, have fun.");
	}
	...
	protected int[] GetValues(FakeBoard board)
	{
		...
		for (int x = 0; x < board.Columns; x++)
		{
			...
			{
				teamCheck = MainClass.Next(teamCheck, board.TeamCount);
