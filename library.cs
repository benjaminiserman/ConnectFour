...
public static class ConnectLibrary // feel free to add your own methods here!
{
	public static Random Random { get; private set; } = new Random(); // a random all set up and ready to use... Try Random.Next();
